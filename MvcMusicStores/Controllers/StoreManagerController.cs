...
namespace MvcMusicStores.Controllers
{
    ...
    public class StoreManagerController : Controller
    {
        ...
        public StoreManagerController(MvcMusicStoresContext context)
        {
            _context = context;
        }
        ...
        {
            var mvcMusicStoresContext = _context.Album.Include(a => a.Artist).Include(a => a.Genre);
            return View(await mvcMusicStoresContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcMusicStoresContext.Album'  is null.");
            }
            var album = await _context.Album.FindAsync(id);
            if (album != null)
            {
